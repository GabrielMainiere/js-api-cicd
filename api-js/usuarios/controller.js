...
export async function deletarInteresseUsuario(req, res) {
  const interesse = await service.deletarInteresseUsuario(
    req.params.idUsuario,
    req.params.idInteresse,
  )
  return res.status(200).json(interesse)
